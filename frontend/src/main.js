...
pluralCaseList.push( {plural: "orderapps/orders", pascal: "OrderappOrder"} )

pluralCaseList.push( {plural: "users/users", pascal: "UserUser"} )

pluralCaseList.push( {plural: "marketings/promotions", pascal: "MarketingPromotion"} )
pluralCaseList.push( {plural: "marketings/coupons", pascal: "MarketingCoupon"} )

pluralCaseList.push( {plural: "stores/menus", pascal: "StoreMenu"} )
pluralCaseList.push( {plural: "stores/stroes", pascal: "StoreStroe"} )
